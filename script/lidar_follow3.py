...
class LidarTracker:
    ...
    def __init__(self):
        ...
        rospy.init_node('lidar_follow3', anonymous=False)
        self.scanSubscriber = rospy.Subscriber('/robot3/scan', LaserScan, self.scancallback)
